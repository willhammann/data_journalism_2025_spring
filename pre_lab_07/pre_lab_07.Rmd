...
p00 |> 
  select(GEOID, NAME, value) |> 
  rename(Population2000=value) -> p00
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer**Median Household Income with MOE by Maryland County
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer**Average income is way higher for the smaller proportion of graduates enrolled in college. 
...
**Task** What is another question you could ask of this data? **Answer**Which counties have the highest enrollment?
