...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer**We create a new dataset with a new field for month using lubridate. Then we groupby/summarise to make the next field the total calls in each of those months and arrange the data in order of most calls. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**Just a white plane.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**I see a bar graph with the month field on the x axis and count of calls field on the y axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer**We've put the x axis in order of ascending call counts instead of chronologically by month. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer**We've flipped the axes. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer**The background is slightly different with white blocks and gray borders instead of vice versa. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer**There's a light blue grayish tone in teh background and the chart is formatted slightly different spacing wise. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer**We've given proper names instead of the standard field names to the axes and also given the chart a title reflecting analysis of the data. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**A dataset including individual dates and the total number of calls on those days. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**A line graph of calls per individual date. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**Dates added weekly but are way too packed. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**Now the data labels are angled but still gross. 
